...
payload = "action=get_more_posts&offset={}&category_id=30"
headers = {
...
class DmsSpider(scrapy.Spider):
    ...
    def parse_post(self, response):
        ...
        item = ItemLoader(item=DmsItem(), response=response)
